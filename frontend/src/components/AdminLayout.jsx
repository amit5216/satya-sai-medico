...
import {
  ...
  Calendar, CalendarDays, Pill, Settings, LogOut, ChevronLeft,
  ChevronRight, Bell, User, Menu, X, ArrowLeft,
  Sun, Moon
} from 'lucide-react';
      ...
      <div className={cn(
        ...
        <header className="h-16 border-b border-border bg-card/80 backdrop-blur-lg flex items-center justify-between px-6 sticky top-0 z-30">
          ...
          <div className="flex items-center gap-2">
            {/* Search removed — each page has its own functional search via DataTable */}
